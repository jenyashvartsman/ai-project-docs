...
Use the required docs as the default baseline for every React app in this repo. Add optional docs only when the app or feature actually uses that strategy.
...
- [state-feature-hooks.md](./optional/by-strategy/state-feature-hooks.md)
- [state-tanstack-query.md](./optional/by-strategy/state-tanstack-query.md)
- [state-zustand.md](./optional/by-strategy/state-zustand.md)
